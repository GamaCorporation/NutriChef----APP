...
const styles = StyleSheet.create({
  ...
  textarea: { borderWidth: 1, borderColor: "#ffa94d", borderRadius: 8, padding: 8, minHeight: 60, marginBottom: 10 },
  ...
  addButton: { backgroundColor: "#ffa94d", padding: 8, borderRadius: 6, alignItems: "center", marginBottom: 10 },
